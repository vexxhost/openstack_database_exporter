...
"id", "mac_address", "device_owner", "device_id", "status",
...
openstack_neutron_port{admin_state_up="true",binding_vif_type="ovs",device_id="compute-device-1",device_owner="compute:nova",fixed_ips="10.13.18.143",mac_address="fa:16:3e:2d:97:08",network_id="74917853-7529-46fc-8545-ed70fe691f03",status="ACTIVE",uuid="883f060a-60a2-48af-aba8-88c45a4b0b58"} 1
openstack_neutron_port{admin_state_up="false",binding_vif_type="unbound",device_id="octavia-device-1",device_owner="Octavia",fixed_ips="10.16.0.90",mac_address="fa:16:3e:9d:fa:55",network_id="74917853-7529-46fc-8545-ed70fe691f03",status="DOWN",uuid="10e61c4b-cefc-4a38-a374-bf241d9411b5"} 1
...
"neutron:LOADBALANCERV2", "lb-device-1", "DOWN",
...
ExpectedMetrics: `# HELP openstack_neutron_port port
# TYPE openstack_neutron_port gauge
openstack_neutron_port{admin_state_up="true",binding_vif_type="ovs",device_id="lb-device-1",device_owner="neutron:LOADBALANCERV2",fixed_ips="10.0.0.1",mac_address="aa:bb:cc:dd:ee:ff",network_id="net-1",status="DOWN",uuid="port-1"} 1
openstack_neutron_port{admin_state_up="true",binding_vif_type="unbound",device_id="",device_owner="",fixed_ips="",mac_address="11:22:33:44:55:66",network_id="net-1",status="DOWN",uuid="port-2"} 1
# HELP openstack_neutron_ports ports
# TYPE openstack_neutron_ports gauge
openstack_neutron_ports 2
# HELP openstack_neutron_ports_lb_not_active ports_lb_not_active
...
ExpectedMetrics: `# HELP openstack_neutron_port port
# TYPE openstack_neutron_port gauge
openstack_neutron_port{admin_state_up="true",binding_vif_type="unbound",device_id="",device_owner="network:distributed",fixed_ips="",mac_address="aa:bb:cc:dd:ee:ff",network_id="net-1",status="DOWN",uuid="port-1"} 1
# HELP openstack_neutron_ports ports
# TYPE openstack_neutron_ports gauge
