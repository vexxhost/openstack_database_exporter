...
"hostname", "resource_type", "total", "allocation_ratio", "reserved", "generation", "used",
}).AddRow(
"cmp-1-svr8204.localdomain", "DISK_GB", 2047, "1.2000000476837158", 0, 20, []uint8("6969"),
).AddRow(
"cmp-1-svr8204.localdomain", "MEMORY_MB", 772447, "1.2999999523162842", 8192, 20, []uint8("1945"),
).AddRow(
"cmp-1-svr8204.localdomain", "VCPU", 96, "3.0000000000000000", 0, 20, []uint8("10"),
).AddRow(
"cmp-5-svr8208.localdomain", "DISK_GB", 2047, "1.2000000476837158", 0, 12, []uint8("0"),
).AddRow(
"cmp-5-svr8208.localdomain", "MEMORY_MB", 772447, "1.0000000000000000", 8192, 12, []uint8("0"),
).AddRow(
"cmp-5-svr8208.localdomain", "PCPU", 96, "1.0000000000000000", 0, 12, []uint8("0"),
)

mock.ExpectQuery(regexp.QuoteMeta(placementdb.GetResourceMetrics)).WillReturnRows(rows)

mock.ExpectQuery(regexp.QuoteMeta(placementdb.GetProviderAllocations)).WillReturnRows(
sqlmock.NewRows([]string{"hostname", "uuid", "resource_type", "used"}).
AddRow("cmp-1-svr8204.localdomain", "a0b15655-e674-4e63-aa64-cde2f5de4402", "DISK_GB", 40).
AddRow("cmp-1-svr8204.localdomain", "a0b15655-e674-4e63-aa64-cde2f5de4402", "MEMORY_MB", 4096).
AddRow("cmp-1-svr8204.localdomain", "a0b15655-e674-4e63-aa64-cde2f5de4402", "VCPU", 2),
)
},
...
sql.NullString{Valid: false}, "VCPU", 16, "2.0", 0, 5, []uint8("4"),
)
...
# HELP openstack_placement_resource_generation resource_generation
# TYPE openstack_placement_resource_generation gauge
openstack_placement_resource_generation{hostname="",resourcetype="VCPU"} 5
# HELP openstack_placement_resource_reserved resource_reserved
# TYPE openstack_placement_resource_reserved gauge
